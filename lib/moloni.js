...
Moloni.prototype.countries = function(call, params, callback) {
	...
	this._request.executeRequest('countries', call, method, params, callback);
	return this;
};
Moloni.prototype.fiscalZones = function(call, params, callback) {
	...
	this._request.executeRequest('fiscalZones', call, method, params, callback);
	return this;
};
Moloni.prototype.languages = function(call, params, callback) {
	...
	this._request.executeRequest('languages', call, method, params, callback);
	return this;
};
