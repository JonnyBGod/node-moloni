...
var moloni = new Moloni({
    client_id: 'imoglobe',
    client_secret: 'f9eb2172fe2c44fb457ba96f57f61e40b30520a9',
    username: 'admin@imoglobe.com',
    password: 'rv2sdecpt'
});

moloni.products('getAll', {company_id: 6390, category_id: 43033}, function (error, result) {
    if (error)
